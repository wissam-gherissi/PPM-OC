...
fold1_t3 = list(itemgetter(*idx1)(PtimeseqsF))
...
fold2_t3 = list(itemgetter(*idx2)(PtimeseqsF))
...
with open('output_files/results/next_activity_and_time_%s.csv' % eventlog, 'w', newline='') as csvfile:
    ...
    for prefix_size in range(2, maxlen):
        print(prefix_size)
        for line, caseid, Ptimes, Ptimes3, PtimesF in zip(lines, caseids, lines_t, lines_t3, lines_t4):
            Ptimes.append(0)
